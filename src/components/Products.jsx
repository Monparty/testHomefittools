        ...
        <div className="group flex flex-col rounded-2xl bg-white overflow-hidden shadow-sm hover:shadow-xl hover:shadow-slate-200 hover:-translate-y-1.5 transition-all duration-300 border border-slate-100">
            ...
            >
                ...
                <div
                    ...
                    style={{
                        backgroundImage:
                            "radial-gradient(circle at 65% 25%, rgba(255,255,255,0.6) 0%, transparent 55%)",
                    }}
                />
                ...
                <span className="absolute top-3 right-3 flex items-center gap-0.5 rounded-full bg-white px-2.5 py-1 text-xs font-heading font-bold text-accent shadow border border-accent/10">
                    <Icon.flame size={12} stroke={2} className="text-accent" />-{discount}%
                </span>
            </div>
...
export default function Products() {
    ...
    return (
        <section id="products" className="py-2 lg:py-16 bg-slate-50">
            <div className="h-4"></div>

            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                {/* Header */}
                <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4" data-aos="fade-up">
                    <SectionHead
                        center={false}
                ...
                >
                    ...
                    {/* Price range */}
                    <div>
                        <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-2.5">ช่วงราคา</p>
                        <div className="flex flex-wrap gap-2">
                ...
                <p className="mt-5 text-sm text-slate-500" data-aos="fade-up" data-aos-delay="80">
                    พบ <span className="font-semibold text-primary">{filtered.length}</span> รายการ
                    {activeCat !== "ทั้งหมด" && (
                        <>
                            {" "}
